...
class AgentExecutorWithToolkit(AgentExecutor):
    ...
    max_agent_tokens: Optional[int] = None  # Limit on total tokens generated by agent (passed to agent for enforcement)
    # Track state for OOM recovery
    _last_intermediate_steps: Optional[List] = None
